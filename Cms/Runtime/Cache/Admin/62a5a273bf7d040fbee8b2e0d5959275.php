...
<script type="text/javascript">var ue_info = UE.getEditor("info");</script>
		...
		<dd><label>状态：</label>
		<input type="radio" name="isshow" value="1" checked="checked" />发布
		<input type="radio" name="isshow" value="0"  />不发布
		</dd>
		<dd><label>日期：</label><input type="date" name="issuedate"/>  <input type="time" name="issuetime"/></dd>
