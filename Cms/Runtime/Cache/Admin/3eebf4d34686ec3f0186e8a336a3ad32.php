	...
	<dl>
		...
		<dd><label>父级栏目：</label>
			<select name="parentid">
				...
				<?php if(is_array($columns)): $k = 0; $__LIST__ = $columns;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><option value ="<?php echo ($vo["id"]); ?>"><?php $__FOR_START_1457__=0;$__FOR_END_1457__=$vo["count"];for($i=$__FOR_START_1457__;$i < $__FOR_END_1457__;$i+=1){ ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php } echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			</select>
		</dd>
		<dd><label>栏目种类：</label>
			<select name="class">
