...
<form action="<?php echo U('Login/login');?>" method="post" id="login">
	...
	<legend>登录smartcms1.0后台系统</legend>
		<label>账<span style="color:#FFFFFF;">账</span>号：<input type="text" name="name" placeholder="请输入账号"/></label>
		<label>密<span style="color:#FFFFFF;">密</span>码：<input type="password" name="pass" placeholder="请输入密码"/></label>
